...
def agregarInventario(inventario,ventasxDia):
    ...
    if type(nombre_producto) not in [str] and type(cantidad_producto) not in[int]:
        raise TypeError('Error el nombre del producto no es un string o la cantidad de numeros no está en enteros')
    return inventario,ventasxDia
